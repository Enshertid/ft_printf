...
/*   Updated: 2019/09/12 18:34:12 by dbendu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	{
// 		ft_memset(new_str + pos, list->flag_minus ? ' ' : '0', list->width - double_len);
// 		pos += list->width - double_len;
// 	}
// 	ft_memcpy(str + pos, iter, double_len);
// 	pos += double_len;
// 	if (!list->flag_minus)
// 	{
// 		ft_memset(new_str + pos, '0', list->width - double_len);
// 		pos += list->width - double_len;
// 	}
// 	new_str[pos] = '\0';
// 	return(str_out);
